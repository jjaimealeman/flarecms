...
('Jane Smith',
 'CTO',
 'TechStartup Inc',
 'Flare CMS has transformed how we manage our content. The plugin architecture is brilliant and the edge deployment is blazing fast.',
 5,
 1,
 1),
...
('Michael Chen',
 'Lead Developer',
 'Digital Agency Co',
 'We migrated from WordPress to Flare CMS and couldn''t be happier. The TypeScript-first approach and modern tooling make development a joy.',
 5,
 1,
 2),
...
('Emily Watson',
 'Technical Director',
 'Media Company',
 'Flare CMS solved our content distribution challenges. The R2 integration for media storage works flawlessly and scales effortlessly.',
 4,
 1,
 5);

...
export interface UserEditPageData {
  ...
  /** When true, show the HTMX-loaded collection permissions section */
  showCollectionPermissions?: boolean
}
    ...
    <div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
              ...
              <div>
                ...
                <dd class="mt-1">
                  ${data.userToEdit.isActive
                    ? '<span class="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 ring-1 ring-inset ring-emerald-700/10 dark:ring-emerald-400/20">Active</span>'
          ...
          ${data.showCollectionPermissions ? `
          <!-- Collection Permissions -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6 mb-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-1">Collection Permissions</h3>
            <p class="text-xs text-zinc-500 dark:text-zinc-400 mb-4">Assign per-collection roles for this user. Admin users bypass these checks.</p>
            <div
              id="collection-permissions-wrapper"
              hx-get="/admin/users/${data.userToEdit.id}/collection-permissions"
              hx-trigger="load"
              hx-swap="innerHTML"
            >

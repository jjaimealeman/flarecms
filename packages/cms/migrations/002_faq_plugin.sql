...
('What is Flare CMS?', 
'Flare CMS is a modern, TypeScript-first headless CMS built for Cloudflare''s edge platform. It provides a complete content management system with admin interface, API endpoints, and plugin architecture.',
'general',
'flarecms, cms, cloudflare',
1,
1),

('How do I get started with Flare CMS?',
...
('What technologies does Flare CMS use?',
'Flare CMS is built with: TypeScript for type safety, Hono.js as the web framework, Cloudflare D1 for the database, Cloudflare R2 for media storage, Cloudflare Workers for serverless execution, and Tailwind CSS for styling.',
'technical',
'technology-stack, typescript, cloudflare',
1,
3),

('How do I create content in Flare CMS?',
...
('Is Flare CMS free to use?',
'Flare CMS is open source and free to use. You only pay for the Cloudflare services you consume (D1 database, R2 storage, Workers execution time). Cloudflare offers generous free tiers for development and small projects.',
'billing',
...
'Flare CMS features a plugin system that allows you to extend functionality. You can create plugins using the PluginBuilder API, add custom routes, models, admin pages, and integrate with external services.',
'technical',
...
'Flare CMS includes a built-in authentication system with JWT tokens, role-based access control (admin, editor, viewer), secure password hashing, and session management. Users can be managed through the admin interface.',
'technical',
